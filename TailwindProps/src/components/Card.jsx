...
function Card({username,btnTxt="Jaano Aur"}) {//passing default value
  return (
    <div className="min-h-screen flex items-center justify-center bg-zinc-900 p-6">
      <div className="max-w-sm w-full p-6 rounded-xl shadow-xl bg-black border border-zinc-800 hover:border-white transition-all duration-300 hover:scale-105 group">
        ...
        <div className="flex items-center justify-between">
          <button className="px-5 py-2 bg-white text-black rounded-lg hover:bg-gray-200 transition">
            {btnTxt}
          </button>
